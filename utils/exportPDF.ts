...
- "anamnesis_short" = только факты из консультации и наблюдаемое состояние животного.
...
- Не сокращай анамнез ценой потери значимых наблюдений о питомце.
- В "next_steps":
  - observe_at_home: практические наблюдения и подготовка к визиту, без искусственного лимита пунктов
  - urgent_now: только признаки или условия срочности, без искусственного лимита пунктов; если признак уже подтверждён, формулируй его как текущую причину срочного обращения
  - plan_visit: практический план очного обращения, что сообщить в клинику и что подготовить к визиту, без искусственного лимита пунктов
- Не сокращай next_steps ценой потери полезной информации для визита.
- Не смешивай анамнез, признаки срочности и план визита в один раздел.
